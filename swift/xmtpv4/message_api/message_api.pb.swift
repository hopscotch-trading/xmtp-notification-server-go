...
public struct Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var filter: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.OriginatorFilter {
    get {_filter ?? Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.OriginatorFilter()}
  ...
  public struct OriginatorFilter: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  fileprivate var _filter: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.OriginatorFilter? = nil
}

/// Response for SubscribeOriginators
public struct Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var response: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.OneOf_Response? = nil

  public var envelopes: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes {
    get {
      if case .envelopes(let v)? = response {return v}
      return Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes()
    }
    set {response = .envelopes(newValue)}
  }
  ...
  public enum OneOf_Response: Equatable, Sendable {
    case envelopes(Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes)
...
extension Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SubscribeOriginatorsRequest"
  ...
  public static func ==(lhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest, rhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest) -> Bool {
...
extension Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.OriginatorFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.protoMessageName + ".OriginatorFilter"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}originator_node_ids\0\u{3}last_seen\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedUInt32Field(value: &self.originatorNodeIds) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._lastSeen) }()
      default: break
      }
    }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // https://github.com/apple/swift-protobuf/issues/1182
    if !self.originatorNodeIds.isEmpty {
      try visitor.visitPackedUInt32Field(value: self.originatorNodeIds, fieldNumber: 1)
    }
    try { if let v = self._lastSeen {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
  ...
  public static func ==(lhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.OriginatorFilter, rhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsRequest.OriginatorFilter) -> Bool {
    if lhs.originatorNodeIds != rhs.originatorNodeIds {return false}
    if lhs._lastSeen != rhs._lastSeen {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SubscribeOriginatorsResponse"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}envelopes\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes?
        var hadOneofValue = false
        if let current = self.response {
          hadOneofValue = true
          if case .envelopes(let m) = current {v = m}
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if case .envelopes(let v)? = self.response {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse, rhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse) -> Bool {
    if lhs.response != rhs.response {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.protoMessageName + ".Envelopes"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}envelopes\0")
  ...
  public static func ==(lhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes, rhs: Xmtp_Xmtpv4_MessageApi_SubscribeOriginatorsResponse.Envelopes) -> Bool {
    if lhs.envelopes != rhs.envelopes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
